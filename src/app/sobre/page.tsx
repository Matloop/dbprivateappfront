...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#121212] flex justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        
        {/* --- COLUNA DA ESQUERDA (CONTEÚDO) --- */}
        <div className="lg:col-span-7 flex flex-col">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
            Consistência e <span className="text-[#d4af37]">Resultados Reais.</span>
          </h1>
          
          <div className="space-y-4 text-base md:text-lg leading-relaxed text-justify font-light text-[#ccc]">
            <p>
          ...
          {/* Divisor Escuro */}
          <div className="w-full h-px bg-[#333] my-10" />

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-3 uppercase tracking-wide border-l-4 border-[#d4af37] pl-3">
              Missão
            </h2>
            <p className="text-[#bbb] leading-relaxed text-justify">
          ...
          <div className="w-full h-px bg-[#333] my-8" />
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-white mb-4 uppercase tracking-wide border-l-4 border-[#d4af37] pl-3">
              Valores
            </h2>
            <ul className="space-y-3">
              {[
                ...
                <li key={index} className="flex items-start gap-3 text-[#bbb]">
          ...
          {/* Links do rodapé (Botões Dark) */}
          <div className="flex flex-wrap gap-4 mt-4">
            <Link 
              href="/cadastre-seu-imovel" 
              className="group flex items-center gap-2 px-6 py-3 bg-[#1a1a1a] border border-[#333] rounded-lg shadow-sm hover:border-[#d4af37] hover:text-[#d4af37] text-[#e0e0e0] transition-all duration-300 font-medium uppercase text-sm"
            >
              <DollarSign className="w-4 h-4 text-[#888] group-hover:text-[#d4af37] transition-colors" /> 
              cadastre seu imóvel
            </Link>
            ...
            <Link 
              ...
              className="group flex items-center gap-2 px-6 py-3 bg-[#1a1a1a] border border-[#333] rounded-lg shadow-sm hover:border-[#d4af37] hover:text-[#d4af37] text-[#e0e0e0] transition-all duration-300 font-medium uppercase text-sm"
            >
              <Mail className="w-4 h-4 text-[#888] group-hover:text-[#d4af37] transition-colors" /> 
              entre em contato
            </Link>
          </div>
        </div>

        {/* --- COLUNA DA DIREITA (VÍDEO STICKY) --- */}
        <div className="lg:col-span-5 relative">
          <div className="lg:sticky lg:top-8 w-full">
            <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-2xl shadow-black/50 border border-[#333] bg-black">
              {/* Lembre-se de colocar o ID do vídeo correto na URL abaixo */}
              <iframe 
            ...
            <div className="mt-4 text-center">
              <p className="text-xs text-[#666] font-bold uppercase tracking-[0.2em]">
